 ...
 * @version   1.53
 * @date      31/12/2004
 * @brief     Définit les méthodes du module conversion php -> PDF.
 *
 * @details    Ce fichier permet de concentrer les méthodes pour la conversion php -> PDF.
 */
require('fpdf.php');
...
//			}
	...
	*/
	...
	/**
	 * @brief      This method returns the number of lines that will a text ocupy on the specified width
	 * 
	 * @param	$w - width
	 * @param	$txt - text
	 * @return    number
	...
	/**
	 * @brief      This method allows printing text with line breaks. It works like a modified MultiCell
	 * 
	 * @param	$w - width
	 * @param	$h - line height
	 * @param	$txt - the outputed text
	 * @param	$border - border(LRTB 0 or 1)
	 * @param	$align - horizontal align 'JLR'
	 * @param	$fill - fill (1/0)
	 * @param	$vh - vertical adjustment - the Multicell Height will be with this VH Higher!!!!
