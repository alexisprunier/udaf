    ...
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                function init(){
				  ...
				  btFinish = $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("buttonFinish uibutton ");
                  btNext = $('<a>'+options.labelNext+'</a>').attr("href","#").addClass("buttonNext uibutton special icon next");
                  btPrevious = $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("buttonPrevious uibutton  special icon prev");
                ...
                function adjustButton(){
                  if(!options.cycleSteps){                
                    if(0 >= curStepIdx){
                      $(btPrevious).addClass("disable");
                    }else{
                      $(btPrevious).removeClass("disable");
                    }
                  ...
                  if(!steps.hasClass('disabled') || options.enableFinishButton){
                    $(btFinish).removeClass("disable");
                  }else{
                    $(btFinish).addClass("disable");
                  }                  
                }
