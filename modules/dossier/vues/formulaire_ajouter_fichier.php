...
<div id="ajouter_fichier">
  ...
  <form name = "form_fichier" action="accueil.php?module=dossier&action=creer_dossier&ajout=fichiers" onsubmit="return valider_nom(this)" method="post" enctype="multipart/form-data">
