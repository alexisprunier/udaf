...
<div id="ajouter_fichier">
  ...
  <form name = "form_fichier" action="accueil.php?module=dossier&action=creer_dossier&ajout=fichiers&id=<?php echo $_SESSION['dossier_ref']; ?>&info=remplir" onsubmit="return valider_nom(this)" method="post" enctype="multipart/form-data">
