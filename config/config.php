...
define('SQL_DSN',      'mysql:dbname=udaf;host=localhost');
define('SQL_USERNAME', 'root');
define('SQL_PASSWORD', '');

// Chemins &eacute; utiliser pour acc&eacute;der aux vues/modeles/librairies
$module = empty($module) ? !empty($_GET['module']) ? $_GET['module'] : 'index' : $module;
define('CHEMIN_VUE',    'modules/'.$module.'/vues/');
define('CHEMIN_MODELE', 'modeles/');
define('CHEMIN_LIB',    'libs/');

// Configurations relatives &eacute; l'intranet
define('AVATAR_LARGEUR_MAXI', 100);
define('AVATAR_HAUTEUR_MAXI', 100);
define('DOSSIER_PHOTOS', 'media/photos/');
define('DOSSIER_VIDEOS', 'media/videos/');
define('DOSSIER_SON', 'media/sons/');
